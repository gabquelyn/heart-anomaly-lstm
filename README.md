...
# Train the TensorFlow model will be skipped if trained model exists at models/heart_anomaly_medical_lstm_176k.h5
...
- **Port**: 8000
- **Technology**: FastApi + TensorFlow.js
- **Purpose**: Real-time cardiac anomaly detection API

### **MQTT Broker (`mosquitto`)** _(Optional)_

- **Ports**: 1883 (MQTT), 9001 (WebSocket)
- **Purpose**: IoT device communication

### **Database (`postgres`)** _(Optional)_
